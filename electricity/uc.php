...
if (!$con) {
  ...
  while($row=mysqli_fetch_assoc($result))
  {
    ...
    <td><div class='d1'><a href='update_cust.php? customer_id= $row[customer_id]&sc_number=$row[sc_number]&name=$row[name]&phone=$row[phone]&branch_name=$row[branch_name]&demand_name=$row[demand_name]'>Update</a></div></td>
    </tr>
    </table>";
  }
?>
